...
/*!**********************************************
 * \fn void RecalculateStartTime(SimplifiedEvent * events, double & st, double & charge, double & hits, double & length) 
...
int main(int argc, char ** argv)
{
  ...
  double uncoatedNull = 0.0;
  double coatedNull = 0.0;
