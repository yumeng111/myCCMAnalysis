...
#
set(ROOT_DEFINITIONS "-D_FORTIFY_SOURCE=2;-DR__HAVE_CONFIG")
set(ROOT_CXX_FLAGS "-O2 -g -pipe -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches   -m64 -mtune=generic -std=c++11 -pipe -fsigned-char -pthread -DR__HAVE_CONFIG")
set(ROOT_C_FLAGS "-O2 -g -pipe -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches   -m64 -mtune=generic -pipe -pthread")
set(ROOT_fortran_FLAGS "-O2 -g -pipe -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches   -m64 -mtune=generic -I/usr/lib64/gfortran/modules -std=legacy")
set(ROOT_EXE_LINKER_FLAGS "-Wl,--as-needed -Wl,-z,relro -rdynamic")
...
get_filename_component(ROOT_INCLUDE_DIRS "${_thisdir}/../../../include/root" ABSOLUTE)


# ROOT configured for the install with relative paths, so use these
get_filename_component(ROOT_LIBRARY_DIR "${_thisdir}/../../../lib64/root" ABSOLUTE)
