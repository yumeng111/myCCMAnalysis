...
struct heap_allocation {
    ...
    #if ( BOOST_VERSION<103900 || defined(__BORLANDC__) || BOOST_WORKAROUND(__IBMCPP__, < 1210) || defined(__SUNPRO_CC) && (__SUNPRO_CC < 0x590) || defined(__cray__) && defined(__clang__))
