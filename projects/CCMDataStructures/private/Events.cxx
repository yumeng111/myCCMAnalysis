...
Events::serialize(Archive& ar, unsigned version) {
    if (version > legacy_events_version_ + 1)
        log_fatal("Attempting to read version %u from file but running version %u of Events class.", version, legacy_events_version_ + 1);
