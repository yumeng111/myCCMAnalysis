...
V2PhysicsList::V2PhysicsList():  G4VModularPhysicsList()
{
	SetVerboseLevel(1); 
...
void V2PhysicsList::ConstructParticle()
{
	decayPhysicsList -> ConstructParticle();
}

void V2PhysicsList::ConstructProcess()
{
	AddTransportation();
