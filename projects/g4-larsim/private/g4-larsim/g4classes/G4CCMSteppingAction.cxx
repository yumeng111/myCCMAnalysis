...
//
//
#include "g4-larsim/g4classes/G4CCMSteppingAction.h"

#include "g4-larsim/g4classes/G4CCMEventAction.h"
#include "g4-larsim/g4classes/G4CCMPMTSD.h"
#include "g4-larsim/g4classes/G4CCMSteppingMessenger.h"
...
G4CCMSteppingAction::G4CCMSteppingAction(G4CCMEventAction* ea)
  : fEventAction(ea)
{
...
void G4CCMSteppingAction::UserSteppingAction(const G4Step* theStep)
{
  ...
  auto trackInformation =
    static_cast<G4CCMUserTrackInformation*>(theTrack->GetUserInformation());
  ...
  if(pdg == -22)
  {
    ...
    if(thePostPoint->GetStepStatus() == fGeomBoundary)
    {
      ...
      if(fExpectedNextStatus == StepTooSmall)
      {
        ...
        {
          G4cout << "G4CCMSteppingAction::UserSteppingAction(): "
          ...
          ed << "G4CCMSteppingAction: "
             << "No reallocation step after reflection!"
             << "Something is wrong with the surface normal or geometry";
          G4Exception("G4CCMSteppingAction:", "G4CCMExpl01", JustWarning, ed, "");
          return;
        }
      }
      fExpectedNextStatus = Undefined;
      switch(boundaryStatus)
      {
                         ...
                         // non-zero efficiency
        {
          ...
          G4String sdName    = "/G4CCMDet/pmtSD";
