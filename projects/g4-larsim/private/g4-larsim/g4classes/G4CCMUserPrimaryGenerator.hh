...
#ifndef G4CCMUserPrimaryGenerator_h
#define G4CCMUserPrimaryGenerator_h 1
...
class G4CCMUserPrimaryGenerator : public G4VUserPrimaryGeneratorAction
{
public:
  G4CCMUserPrimaryGenerator();
  virtual ~G4CCMUserPrimaryGenerator();
