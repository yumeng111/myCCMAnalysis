...
G4CCMDecayPhysics::G4CCMDecayPhysics(G4int ver):  G4VModularPhysicsList()
{
...
G4CCMDecayPhysics::~G4CCMDecayPhysics()
{  
...
void G4CCMDecayPhysics::ConstructParticle() {
...
void G4CCMDecayPhysics::ConstructProcess() {
    AddTransportation();
    ...
    std::cout << "radioactive decay things" << std::endl;
}

void G4CCMDecayPhysics::SetCuts() {
    if (verboseLevel >1){
