...
G4CCMEventAction::G4CCMEventAction(const G4CCMDetectorConstruction* det)
  : fDetector(det)
{
  fEventMessenger = new G4CCMEventMessenger(this);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4CCMEventAction::~G4CCMEventAction() { delete fEventMessenger; }
...
void G4CCMEventAction::EndOfEventAction(const G4Event* anEvent)
{
  ...
  if(G4VVisManager::GetConcreteInstance())
  {
    ...
    {
      auto trj = (G4CCMTrajectory*) ((*(anEvent->GetTrajectoryContainer()))[i]);
