...
G4CCMUserPrimaryGenerator::G4CCMUserPrimaryGenerator()
...
void G4CCMUserPrimaryGenerator::GeneratePrimaries(G4Event* anEvent)
{
...
void G4CCMUserPrimaryGenerator::shootArgon(G4Event* anEvent) {
...
void G4CCMUserPrimaryGenerator::shootDarkMatter(G4Event* anEvent) {
...
void G4CCMUserPrimaryGenerator::shootSodium(G4Event* anEvent) {
...
void G4CCMUserPrimaryGenerator::shootCosmic(G4Event* anEvent) {
  G4ParticleTable* particleTable = G4ParticleTable::GetParticleTable();
...
void G4CCMUserPrimaryGenerator::shootALP(G4Event* anEvent) {
  //rewrites the particle energy for the particle creation
  nameString = "ALP";
...
void G4CCMUserPrimaryGenerator::shootInverseBeta(G4Event* anEvent) {
  G4ParticleTable* particleTable = G4ParticleTable::GetParticleTable();
