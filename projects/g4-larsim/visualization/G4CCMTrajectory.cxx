...
G4CCMTrajectory::G4CCMTrajectory(const G4Track* aTrack) : G4Trajectory(aTrack) {
...
G4CCMTrajectory::G4CCMTrajectory(G4CCMTrajectory& right) : G4Trajectory(right) , fWls(right.fWls) , fDrawit(right.fDrawit) {
    fParticleDefinition = right.fParticleDefinition;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4CCMTrajectory::DrawTrajectory() const {
