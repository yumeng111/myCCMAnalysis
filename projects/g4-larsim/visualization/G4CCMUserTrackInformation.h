...
//
//
/// \file optical/LXe/include/G4CCMUserTrackInformation.hh
/// \brief Definition of the G4CCMUserTrackInformation class
//
#include "G4VUserTrackInformation.hh"
#include "globals.hh"

#ifndef G4CCMUserTrackInformation_h
#  define G4CCMUserTrackInformation_h 1

enum G4CCMTrackStatus
{
  active               = 1,
  hitPMT               = 2,
  absorbed             = 4,
  boundaryAbsorbed     = 8,
  primaryLArDeposition = 16,
  inactive             = 14
};
...
/*G4CCMTrackStatus:
  ...
  primaryLArDeposition: primiary scintillation photon deposited in lar  
...
class G4CCMUserTrackInformation : public G4VUserTrackInformation
{
 public:
  G4CCMUserTrackInformation() = default;
  ~G4CCMUserTrackInformation() override = default;
