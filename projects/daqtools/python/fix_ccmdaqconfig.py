...
class FixCCMDAQConfig(I3ConditionalModule):
    def __init__(self, context):
        ...
        channel_types = [["PMT 8in coated", "PMT 8in uncoated", "PMT 1in"][0 if (x[0] == "C" and c) else (1 if (x[0] == "C" and not c) else (2 if x[0] == "V" else None))]for x, c in zip(self.mapping_data[:, 3], coated)]
