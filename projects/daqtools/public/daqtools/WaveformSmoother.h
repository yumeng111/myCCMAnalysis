...
public:
    WaveformSmoother(std::vector<uint16_t>::const_iterator begin, std::vector<uint16_t>::const_iterator end, double delta_t, double tau) :
        begin(begin), end(end), N(std::distance(begin, end)), smoothed_wf(3), index(0), max_computed(0), delta_t(delta_t), tau(tau) {
...
class WaveformSmootherDerivative : public I3FrameObject {
    std::vector<uint16_t>::const_iterator begin;
    std::vector<uint16_t>::const_iterator end;
    size_t N;
    std::vector<double> smoothed_wf;
    ...
    double x;
public:
    WaveformSmootherDerivative(std::vector<uint16_t>::const_iterator begin, std::vector<uint16_t>::const_iterator end, double delta_t, double tau) :
...
class WaveformSmootherDerivativeAndBaseline : public I3FrameObject {
    std::vector<uint16_t>::const_iterator begin;
    std::vector<uint16_t>::const_iterator end;
    size_t N;
    std::vector<double> smoothed_wf;
    ...
    double x;
public:
    WaveformSmootherDerivativeAndBaseline(std::vector<uint16_t>::const_iterator begin, std::vector<uint16_t>::const_iterator end, double delta_t, double tau) :
        begin(begin), end(end), N(std::distance(begin, end)), smoothed_wf(3), derivative(1), index(0), max_computed(0), delta_t(delta_t), tau(tau) {
        int init_avg_end_idx = std::min(3 * std::max(int(tau / delta_t), 1), int(N));
        double exp_start = 0.0;
        std::vector<uint16_t>::const_iterator x_it = begin;
