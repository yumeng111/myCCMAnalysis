...
//_________________________________________________________________________________
std::ostream& I3OpheliaFirstGuessTrack::Print(std::ostream& os) const
{
   os << "I3OpheliaFirstGuessTrack:\n"
      << "  linefit velocity  : (" << xvel_ << ',' << yvel_ << ',' << zvel_ << ")\n"
      << "  CenterOfBrightness: (" << xpos_ << ',' << ypos_ << ',' << zpos_ << ")\n"
      << "  FitSuccess        : " << fitsuccess_ << '\n'
      << "  FitQuality        : " << fitquality_ << '\n';
   return os;
}
