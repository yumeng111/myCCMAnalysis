...
I3ParticleIntersections::~I3ParticleIntersections() {}
...
std::ostream& I3ParticleIntersections::Print(std::ostream& os) const
{
  const std::vector<I3Position>& vpos = GetIntersections();
