...
//______________________________________________________________________________
std::ostream& OMKeySet::Print(std::ostream& os) const
{
    os << "OMKeySet(["
       << sttools::omkey_range_vector_to_strings_string(GetOMKeyRangeVector())
       << "], ["
       << sttools::omkey_range_vector_to_oms_string(GetOMKeyRangeVector())
       << "])";
    return os;
}
