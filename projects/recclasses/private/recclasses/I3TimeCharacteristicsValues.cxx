...
std::ostream& I3TimeCharacteristicsValues::Print(std::ostream& oss) const
{
    oss << "I3TimeCharacteristicsValues("                                                  <<
        "TimeLengthFWHM [ns]: "    << GetTimeLengthFwhm()/I3Units::ns << ", " <<
        "TimeLengthLastFirst [ns]: "    << GetTimeLengthLastFirst()/I3Units::ns << ", " <<
        "TimeLengthMaxGap [ns]: "    << GetTimeLenghtMaxgap()/I3Units::ns << ", " <<
        "ZPattern: "    << GetZPattern() << ", " <<
        ")";
    return oss;
