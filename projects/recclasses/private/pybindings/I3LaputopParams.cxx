...
void register_I3LaputopParams()
{
  ...
  enum_<Parameter::Enum>("LaputopParameter")
    ...
    .value("CurvParabA", Parameter::CurvParabA)
    .value("CurvGaussD", Parameter::CurvGaussD)
    .value("CurvGaussN", Parameter::CurvGaussN)
  ...
  enum_<FrontDelay::Enum>("LaputopFrontDelay")
    ...
    .value("GaussParabolaEmily", FrontDelay::GaussParabolaEmily)
    .value("GaussParabolaFromParams", FrontDelay::GaussParabolaFromParams)
    ;
  ...
  class_<I3LaputopParams,
    ...
    .def_readwrite("ndf", &I3LaputopParams::ndf_)
