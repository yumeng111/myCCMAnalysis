...
To get a deeper understanding of how I3LaputopParams works, we suggest the documentation of :ref:`parameter_storage` , then this document, and finally the :ref:`doxygen documentation <recclasses-cpp>` (or the source code). A mini-tutorial follows.
