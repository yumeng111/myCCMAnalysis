...
public:
  ...
  double chi2_LDF_;                 ///< "reduced" chi2 of LDF fit, not proper definition, but kept for backward-compatibility
  double chi2_Time_;                ///< "reduced" chi2 of Time fit, not proper definition, but kept for backward-compatibility
  int ndf_;                         ///< Ndof as used by Guilliver
