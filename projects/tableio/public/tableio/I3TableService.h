...
class I3TableService {
    ...
    private:
        bool EventHeadersEqual(const CCMEventHeader& header1,
                               const CCMEventHeader& header2);
        
        std::vector<CCMEventHeaderConstPtr> eventHeaderCache_;
