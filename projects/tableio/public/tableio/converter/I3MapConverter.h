...
template <class converter_type,
          typename map_type = I3Map<CCMPMTKey, std::vector<typename converter_type::booked_type> >,
          typename frameobject_type = map_type >
class I3MapCCMPMTKeyVectorConverter
...
public:
  ...
  // For both options
  I3MapCCMPMTKeyVectorConverter(bool bookGeometry, std::string bookToParticle)
    : bookGeometry_(bookGeometry),
    bookToParticle_(bookToParticle)
  {}
  // For just one
  I3MapCCMPMTKeyVectorConverter(std::string bookToParticle)
    : bookGeometry_(false),
    bookToParticle_(bookToParticle)
  {}
  // For just the other
  I3MapCCMPMTKeyVectorConverter(bool bookGeometry)
    : bookGeometry_(bookGeometry),
    bookToParticle_("")
  {}
  // For neither
  I3MapCCMPMTKeyVectorConverter()
    : bookGeometry_(false),
    bookToParticle_("")
  {}
