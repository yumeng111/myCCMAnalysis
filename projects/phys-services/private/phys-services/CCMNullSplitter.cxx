...
class CCMNullSplitter : public I3ConditionalModule, public CCMSplitter
{
	public:
		CCMNullSplitter(const I3Context& context);
		void Configure();
...
I3_MODULE(CCMNullSplitter);

CCMNullSplitter::CCMNullSplitter(const I3Context& context) :
...
void
CCMNullSplitter::DAQ(I3FramePtr frame)
{
	PushFrame(frame);
