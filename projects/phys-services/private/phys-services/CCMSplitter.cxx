...
CCMSplitter::CCMSplitter(const I3Configuration& config) :
...
CCMSplitter::~CCMSplitter() {}

I3FramePtr
CCMSplitter::GetNextSubEvent(I3FramePtr daq) {
    if (last_daq != daq) {
        last_daq = daq;
        last_subevent_id = -1;
    }
    ...
    CCMEventHeaderPtr header(new CCMEventHeader(frame->Get<CCMEventHeader>()));
    ...
    frame->Delete("CCMEventHeader");
    frame->Put("CCMEventHeader", header);
